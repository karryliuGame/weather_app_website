...
def home(request):
    ...
    if request.method == "POST":
        ...
        api_request = requests.get("https://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode="+zipcode+"&distance=25&API_KEY=90AF44FF-F4CD-422C-9352-BC8992691A0B")
        ...
        if api[0]['Category']['Name'] == "Good":
            ...
            category_description = "category_description = '201 to 300	Health alert: The risk of health effects is increased for everyone."
        ...
        api_request = requests.get("https://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=94583&distance=25&API_KEY=90AF44FF-F4CD-422C-9352-BC8992691A0B")
